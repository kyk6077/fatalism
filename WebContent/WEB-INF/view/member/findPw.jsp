...
<c:import url="../../../temp/h.jsp"></c:import>
	<div id="sub_container">
		<div id="sub_contents">
			...
			<form action="./findPw.do" method="post" class="findPw" name="frm">
			<div class="login">
				<div class="findId">
					<fieldset>
						<h6 style="font-weight: bold;">이메일로 찾기</h6>
						<p>
							<strong class="name"> > 아이디</strong>
							<input type="text" size="28" name="id">
						</p> 
						<p>
						...
						<div class="join_button">
							<a href="#" class="viewId">
								<img alt="확인" src="../images/btn_submit.png">
							</a>
						</div>
					</fieldset>
				</div>
			...
			<form action="./findPw2.do" method="post" class="findPw2" name="frm2">
			<div class="login">
				<div class="findId">
					<fieldset>
