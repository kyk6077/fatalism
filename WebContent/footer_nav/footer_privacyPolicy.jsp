...
<div class="xans-element- xans-mall xans-mall-privacy ec-base-box typeThinBg  "><div class="agree">
        <a href="file://\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'페이탈리즘\\\\\\\\\\\\\\\\\'">'페이탈리즘'</a>은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br />
...
회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다. 파기절차 및 방법은 다음과 같습니다.<p>
...
화사의 개인정보 수탁업체 및 위탁업무의 내용은 아래와 같습니다. <p>
...
───────────────────────────────────<br />
　　　　　　(주)다날<br />
　　　　　　네이버페이                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;결제, 구매안전서비스 제공,<br />
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;(주)케이지이니시스 &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;실명확인, 본인인증 등<br />
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;카페24(주)<br />
───────────────────────────────────</p><p>

■ 이용자 및 법정대리인의 권리와 그 행사방법<p>
...
■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항<p>

회사는 귀하의 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’ 등을 운용합니다. 쿠키란 oo의 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다. 회사은(는) 다음과 같은 목적을 위해 쿠키를 사용합니다.<p>
...
회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다.<p>

고객서비스담당 부서 : 장한샘,김은미<br />
전화번호 : 070-4146-6369<br />
이메일 : <a href="mailto:fatalismofficial@naver.com">fatalismofficial@naver.com</a><p>

개인정보관리책임자 성명 : 장한샘<br />
전화번호 : 070-4146-6369<br />
이메일 : fatalismofficial@naver.com<p>
...
4.경찰청 사이버테러대응센터 (<a href="http://www.ctrc.go.kr/02-392-0330">www.ctrc.go.kr/02-392-0330</a>) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;	</p>    </div>
</div>
